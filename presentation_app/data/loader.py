...
class DataLoader:
    ...
    @staticmethod
    def _read_csv_normalized(file_path: Path, column_mapping: dict) -> pd.DataFrame:
        """Read a CSV, clean column names, apply mapping, and return with a datetime index."""
    ...
    def load_tide_csv(file_path: Path, start_date: Optional[pd.Timestamp] = None,
        ...
        df = DataLoader._read_csv_normalized(file_path, column_mapping)
